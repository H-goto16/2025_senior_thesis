...
\caption{語彙\texttt{smartphone}の有無による比較（1/5）：左=WITHOUT, 右=WITH}
...
\caption{語彙\texttt{smartphone}の有無による比較（2/5）：左=WITHOUT, 右=WITH}
...
\caption{語彙\texttt{smartphone}の有無による比較（3/5）：左=WITHOUT, 右=WITH}
...
\caption{語彙\texttt{smartphone}の有無による比較（4/5）：左=WITHOUT, 右=WITH}
...
\caption{語彙\texttt{smartphone}の有無による比較（5/5）：左=WITHOUT, 右=WITH}
